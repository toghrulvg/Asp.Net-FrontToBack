#pragma checksum "C:\Users\hp\Desktop\Asp.Net-FrontToBack\Aspi.Net-FrontToBack2\Aspi.Net-FrontToBack2\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c58fb5996e14ea5fc27a631add4875d1285f21ce"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c58fb5996e14ea5fc27a631add4875d1285f21ce", @"/Views/Home/Index.cshtml")]
...
<section class=""service-wrapper py-3"">
    <div class=""container-fluid pb-3"">
        <div class=""row"">
            <h2 class=""h2 text-center col-12 py-5 semi-bold-6");
            WriteLiteral(@"00"">Services</h2>
        ...
        <div class=""col-md-12"">
            <ul class=""nav d-flex justify-content-center"">
                <li class=""nav-item mx-lg-4"">
                    <a class=""filter-btn nav-link btn-outline-primary active shado");
            WriteLiteral(@"w rounded-pill text-light px-4 light-300"" href=""#"" data-filter="".project"">All</a>
                </li>
                <li class=""nav-item mx-lg-4"">
...
<section class=""container overflow-hidden py-5"">
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects"">
        ...
        <!-- Start Recent Work -->
        <div c");
            WriteLiteral(@"lass=""col-xl-3 col-md-4 col-sm-6 project ui branding"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            ...
            WriteLiteral(@"=""./assets/img/services-02.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <!-- Start Recent Work -->
        <div class=""col-xl-3 col-md-4 col-sm-6 project brandin");
            WriteLiteral(@"g"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
       ...
       ");
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
                        <span class=""btn btn-ou");
            WriteLiteral(@"tline-light rounded-pill mb-lg-3 px-lg-4 light-300"">Branding</span>
                        <p class=""card-text"">Lorem ipsum dolor sit amet, consectetur adipisicing</p>
                    </div>
                </div>
            </a>
    ...
    <div class=""container py-5"">
        <div class=""row d-flex justify-content-center text-center"">
            ...
            <div class=""col-lg-3 col-12 pt-4"">
                <a href=""#"" class=""btn btn-primary rounded-pill btn-block shadow px-4 py-2""");
            WriteLiteral(@">View Our Work</a>
            </div>
        </div>
    </div>
</section>
...
<section class=""py-5 mb-5"">
    <div class=""container"">
        ...
        <div class=""row gy-5 g-lg-5 mb-4"">
                ...
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                            ...
                            <p class=""card-text"">Ullamco laboris nisi ut ali");
            WriteLiteral(@"quip ex</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Recent Work -->
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""re");
            WriteLiteral(@"cent-work card border-0 shadow-lg overflow-hidden"">
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
         ");
            WriteLiteral(@"               <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
